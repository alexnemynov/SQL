CREATE DATABASE IF NOT EXISTS testing_stepik;
USE testing_stepik;

-- ALTER TABLE attempt
-- DROP FOREIGN KEY attempt_ibfk_1, 
-- DROP FOREIGN KEY attempt_ibfk_2;
...
-- ALTER TABLE testing
-- DROP FOREIGN KEY testing_ibfk_1,
-- DROP FOREIGN KEY testing_ibfk_2,
-- DROP FOREIGN KEY testing_ibfk_3;
